    ...
    public class ImportListSyncServiceFixture : CoreTest<ImportListSyncService>
    {
        ...
        public void SetUp()
        {
            ...
            Mocker.GetMock<IImportListFactory>()
                  .Setup(v => v.All())
                  .Returns(new List<ImportListDefinition> { new ImportListDefinition { ShouldMonitor = ImportListMonitorType.EntireSite } });
        ...
        [TestCase(ImportListMonitorType.EntireSite, true)]
