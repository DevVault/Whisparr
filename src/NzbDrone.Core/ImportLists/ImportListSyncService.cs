        ...
        private void ProcessReports(List<ImportListItemInfo> reports)
        {
            ...
            foreach (var report in reports)
            {
                ...
                if (existingTvdbIds.Any(x => x == report.TpdbSiteId))
                {
                    ...
                    if (importList.ShouldMonitor == ImportListMonitorType.SpecificEpisode && report.TpdbEpisodeId > 0)
                    {
                        ...
                        AddOptions = new AddSeriesOptions
                                     {
                                         ...
                                         Monitor = importList.ShouldMonitor == ImportListMonitorType.EntireSite ? MonitorTypes.All : MonitorTypes.None
                                     }
                    };
